...
def generate():
    ...
    ob_layers = ["\tSandstoneUnit ab"+str(i)+" = new SandstoneUnit(null, null, null, null, null, null, "+str(overburden[i][1])+".0, 2, null);\n\tDepositionGenerator depAb"+str(i)+" = new DepositionGenerator(ab"+str(i)+", 2.0, "+str(overburden[i][2])+");\n\tdl = new List<DepositionGenerator>(depAb"+str(i)+", dl);\n" for i in range(2)]
